...
function ParticleField() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Mouse spotlight — cinematic red key light following the cursor
      ...
      for (const p of dots) {
        ...
        // Particles near the cursor glow red; distant ones stay white dust
...
export default function Hero({ started }: { started: boolean }) {
  ...
  // Parallax: content drifts up slower than the scroll, then fades
  ...
  return (
    ...
    >
      ...
      />
      <ParticleField />
      {/* Bottom fade into the page — the classic billboard gradient */}
      <div
        aria-hidden
      ...
      {started && (
        <motion.div style={{ y, opacity }} className="relative z-10 mx-auto max-w-5xl px-6 text-center">
          ...
          <motion.div
            ...
            className="mb-6 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-[12px] font-medium tracking-wide text-mute"
          >
            <span className="font-bold text-[#46d369]">98% Match</span>
          ...
          <motion.p
            ...
            className="mt-6 min-h-[1.75rem] text-lg font-medium text-ink/90 sm:text-xl"
            aria-live="polite"
          >
            {typed}
          ...
          <motion.p
            ...
            className="mx-auto mt-4 max-w-2xl text-pretty text-sm leading-relaxed text-mute sm:text-base"
          >
            {profile.subHeadline} — building end-to-end ML pipelines, IoT-based
            real-time analytics, and dashboards that turn raw data into clear answers.
          </motion.p>
